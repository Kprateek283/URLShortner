...
import { setName, setEmail, setPassword, setConfirmPassword, clearError, setError } from '../store/slices/signupSlice';
...
const Signup = () => {
    ...
    const { name, email, password, confirmPassword, error, loading, success } = useSelector(
